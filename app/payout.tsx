...
const styles = StyleSheet.create({
  ...
  summaryLabel: { color: 'rgba(245,230,200,0.8)', fontSize: 14, marginBottom: 4 },
  summaryAmt: { color: Colors.white, fontSize: 32, fontFamily: Fonts.serifBold },
  summarySub: { color: 'rgba(245,230,200,0.8)', fontSize: 12, marginTop: 4 },
  card: { backgroundColor: Colors.surface, marginHorizontal: 16, marginBottom: 8, padding: 16, borderRadius: 8, borderWidth: 1, borderColor: Colors.border, borderTopColor: '#2E3F34', borderLeftColor: '#2E3F34', borderBottomColor: '#1A261F', borderRightColor: '#1A261F', shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 3 },
  cardRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  cardTitle: { color: Colors.white, fontFamily: Fonts.serifBold, fontSize: 16 },
