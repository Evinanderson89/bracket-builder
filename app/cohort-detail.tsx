...
const styles = StyleSheet.create({
  ...
  hudLabel: { fontSize: 11, color: Colors.textSecondary, textTransform: 'uppercase', fontFamily: Fonts.sansMedium, letterSpacing: 0.7 },
  ...
  tabBtnTextActive: { color: Colors.white, fontFamily: Fonts.sansBold },
  scroll: { flex: 1 },
  ...
  emptyTitle: { fontSize: 18, fontFamily: Fonts.serifBold, color: Colors.white, marginBottom: 8 },
  ...
  emptyBtnText: { color: Colors.primary, fontFamily: Fonts.sansBold },
  bracketCard: { backgroundColor: Colors.surface, borderRadius: 12, marginBottom: 16, borderWidth: 1, borderColor: Colors.border, borderTopColor: '#2E3F34', borderLeftColor: '#2E3F34', borderBottomColor: '#1A261F', borderRightColor: '#1A261F', shadowColor: Colors.shadow, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 8, elevation: 4 },
  bracketTop: {
    flexDirection: 'row',
  ...
  bracketTitle: { color: Colors.white, fontFamily: Fonts.serifBold, fontSize: 16 },
  pill: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
  pillActive: { backgroundColor: 'rgba(127,179,168,0.2)' },
  pillComplete: { backgroundColor: 'rgba(76,175,80,0.2)' },
  pillText: { fontSize: 10, fontFamily: Fonts.sansMedium, color: Colors.white },
  ...
  winnerLabel: { color: Colors.accent, fontFamily: Fonts.sansBold, marginRight: 6 },
  ...
  totalLabel: { color: Colors.textSecondary, fontSize: 10, textTransform: 'uppercase', fontFamily: Fonts.sansMedium },
  totalValue: { color: Colors.textPrimary, fontSize: 18, fontFamily: Fonts.serifBold, marginTop: 2 },
  scoreAccessWrap: {
    backgroundColor: Colors.surface,
    borderWidth: 1,
    borderColor: Colors.border,
  ...
  scoreAccessTitle: { color: Colors.info, fontFamily: Fonts.serifBold, fontSize: 13 },
  ...
  scoreAccessManageBtn: {
    ...
    backgroundColor: 'rgba(127,179,168,0.14)',
    borderRadius: 8,
    paddingVertical: 10,
    alignItems: 'center',
  },
  scoreAccessManageText: { color: Colors.info, fontFamily: Fonts.sansBold, fontSize: 12 },
  ...
  scoreAccessPickRowSel: {
    borderColor: Colors.info,
    backgroundColor: 'rgba(127,179,168,0.10)',
  },
  ...
  pendingTitle: { color: Colors.warning, fontFamily: Fonts.serifBold, fontSize: 13, marginBottom: 8 },
  ...
  pendingPayBtnText: { color: Colors.white, fontFamily: Fonts.sansBold, fontSize: 11 },
  pendingRemoveBtn: {
    marginLeft: 6,
    borderRadius: 6,
    borderWidth: 1,
  ...
  editLink: { color: Colors.primary, fontFamily: Fonts.sansBold },
  rosterRow: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: Colors.surface,
  ...
  entryCount: { color: Colors.white, fontSize: 14, fontFamily: Fonts.serifBold },
  entryLabel: { color: Colors.textSecondary, fontSize: 10, textTransform: 'uppercase' },
  elimBadge: { backgroundColor: 'rgba(192,57,43,0.2)', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  elimText: { color: Colors.danger, fontSize: 12, fontFamily: Fonts.sansBold },
  footer: {
    position: 'absolute',
    bottom: 0,
    left: 0,
  ...
  deployBtnText: { color: Colors.white, fontFamily: Fonts.sansBold, fontSize: 16 },
  ...
  modalTitle: { fontSize: 18, fontFamily: Fonts.serifBold, color: Colors.white },
  doneText: { color: Colors.primary, fontSize: 16, fontFamily: Fonts.sansBold },
