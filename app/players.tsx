            ...
            {sorted.length === 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <Text style={[styles.listItemSub, selected === u.id && { color: 'rgba(245,230,200,0.8)' }]}>
...
const styles = StyleSheet.create({
  ...
  listTitle: { fontSize: 18, fontFamily: Fonts.serifBold, color: Colors.white },
  addBtn: { backgroundColor: Colors.primary, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
  addBtnText: { color: Colors.white, fontFamily: Fonts.sansBold },
  sortBar: {
  ...
  sortChipText: { fontSize: 12, fontFamily: Fonts.sansMedium, color: Colors.textPrimary },
  sortChipTextActive: { color: Colors.white },
  list: { flex: 1 },
  requestSection: {
    margin: 12, padding: 12, borderRadius: 10, borderWidth: 1,
    borderColor: Colors.warning, backgroundColor: 'rgba(218,165,32,0.08)',
  },
  requestTitle: { color: Colors.warning, fontFamily: Fonts.serifBold, marginBottom: 10 },
  requestCard: {
  ...
  requestBtnText: { color: Colors.white, fontFamily: Fonts.sansBold, fontSize: 12 },
  listItem: { padding: 16, borderBottomWidth: 1, borderBottomColor: Colors.border },
  listItemActive: { backgroundColor: Colors.primary },
  listItemName: { fontSize: 16, fontFamily: Fonts.serifBold, color: Colors.textPrimary, marginBottom: 4 },
  textWhite: { color: Colors.white },
  listItemSub: { fontSize: 12, color: Colors.textSecondary },
  // Action column
  actionCol: { flex: 1, backgroundColor: Colors.background },
  actionTitle: { fontSize: 18, fontFamily: Fonts.serifBold, color: Colors.white, padding: 16 },
  actions: { padding: 16, gap: 12 },
  infoCard: {
    backgroundColor: Colors.surface, padding: 16, borderRadius: 8,
    borderWidth: 1, borderColor: Colors.border, marginBottom: 4,
  },
  infoName: { fontSize: 20, fontFamily: Fonts.serifBold, color: Colors.textPrimary, marginBottom: 4 },
  ...
  actionBtnText: { color: Colors.white, fontSize: 16, fontFamily: Fonts.sansBold },
  ...
  saveBtnText: { color: Colors.white, fontFamily: Fonts.sansBold },
  // Modal
  ...
  modalTitle: { fontSize: 20, fontFamily: Fonts.serifBold, color: Colors.danger, marginBottom: 8 },
