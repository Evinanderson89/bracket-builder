...
const styles = StyleSheet.create({
  ...
  emptyBtnText: { color: Colors.white, fontFamily: Fonts.sansBold },
  card: {
  ...
  cardType: { fontSize: 12, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 1, fontFamily: Fonts.sansMedium },
  liveBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(192,57,43,0.2)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
  liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: Colors.danger, marginRight: 4 },
  liveText: { color: Colors.danger, fontSize: 10, fontFamily: Fonts.sansMedium },
  cardName: { fontSize: 20, fontFamily: Fonts.serifBold, color: Colors.white, marginBottom: 4 },
  ...
  openBtnText: { color: Colors.primary, fontFamily: Fonts.sansBold },
  delIcon: { padding: 12, width: 84, alignItems: 'center', justifyContent: 'center' },
  delIconText: { color: Colors.danger, fontFamily: Fonts.sansMedium, fontSize: 12, textTransform: 'uppercase' },
  fab: {
    position: 'absolute',
    bottom: 24,
    right: 24,
  ...
  fabText: { color: Colors.white, fontFamily: Fonts.sansBold, fontSize: 16 },
  overlay: { flex: 1, backgroundColor: 'rgba(10,22,16,0.85)', justifyContent: 'center', padding: 20 },
  ...
  modalTitle: { fontSize: 20, fontFamily: Fonts.serifBold, color: Colors.white },
  closeText: { fontSize: 20, color: Colors.textSecondary, fontWeight: 'bold' },
  label: { color: Colors.textSecondary, fontSize: 12, fontFamily: Fonts.sansMedium, marginBottom: 8, marginTop: 4, textTransform: 'uppercase' },
  input: {
  ...
  centerChipText: { color: Colors.primary, fontSize: 12, fontFamily: Fonts.sansMedium, marginRight: 8 },
  ...
  centerResultAdd: { color: Colors.primary, fontFamily: Fonts.sansBold, fontSize: 12, marginLeft: 10 },
  ...
  typeBtnActive: { borderColor: Colors.primary, backgroundColor: 'rgba(201,168,76,0.12)' },
  typeBtnText: { color: Colors.textSecondary, fontFamily: Fonts.sansBold },
  typeBtnTextActive: { color: Colors.primary, fontFamily: Fonts.sansBold },
  ...
  windowBtnActive: { borderColor: Colors.primary, backgroundColor: 'rgba(201,168,76,0.12)' },
  ...
  sourceItemActive: { borderColor: Colors.primary, backgroundColor: 'rgba(201,168,76,0.12)' },
  ...
  submitBtnText: { color: Colors.white, fontFamily: Fonts.sansBold, fontSize: 16 },
  ...
  cancelBtnText: { color: Colors.textPrimary, fontFamily: Fonts.sansBold },
  confirmDelBtn: { flex: 1, backgroundColor: Colors.danger, padding: 12, borderRadius: 8, alignItems: 'center' },
  confirmDelBtnText: { color: Colors.white, fontFamily: Fonts.sansBold },
});
