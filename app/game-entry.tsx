...
const styles = StyleSheet.create({
  ...
  selTitle: { fontSize: 18, fontFamily: Fonts.bodyBold, color: Colors.white, marginBottom: 8 },
  selSub: { fontSize: 14, fontFamily: Fonts.bodyRegular, color: Colors.white, opacity: 0.9, lineHeight: 19 },
  dropBtn: {
    flexDirection: 'row',
  ...
  dropBtnText: { fontSize: 15, color: Colors.headerDark, fontFamily: Fonts.bodySemiBold, flex: 1 },
  dropBtnOff: { opacity: 0.55 },
  dropArrow: { fontSize: 12, color: Colors.textSecondary, marginLeft: 8 },
  syncBtn: {
    backgroundColor: Colors.warmWhite20,
    paddingVertical: 10,
  ...
  syncBtnText: { color: Colors.white, fontFamily: Fonts.bodyBold },
  accessWarn: {
    borderRadius: 10,
    borderWidth: 1,
  ...
  accessWarnTitle: { color: Colors.warning, fontFamily: Fonts.bodySemiBold, fontSize: 12, marginBottom: 3 },
  accessWarnText: { color: Colors.textPrimary, fontFamily: Fonts.bodyRegular, fontSize: 12, lineHeight: 17 },
  contextWrap: {
    borderRadius: 10,
    borderWidth: 1,
  ...
  contextText: { color: Colors.textSecondary, fontFamily: Fonts.bodyRegular, fontSize: 12, lineHeight: 17 },
  ...
  dropTitle: { fontSize: 18, fontFamily: Fonts.bodyBold, color: Colors.textPrimary },
  closeBtn: { fontSize: 20, color: Colors.textSecondary, fontFamily: Fonts.bodyBold },
  dropList: { maxHeight: 400 },
  dropEmpty: { padding: 18 },
  dropEmptyText: { color: Colors.textSecondary, fontFamily: Fonts.bodyRegular, fontSize: 13, lineHeight: 18 },
  ...
  dropItemText: { fontSize: 16, color: Colors.textPrimary, fontFamily: Fonts.bodySemiBold },
  dropItemSub: { fontSize: 12, color: Colors.textSecondary, fontFamily: Fonts.bodyRegular, marginTop: 2 },
  dropItemTextSel: { color: Colors.white },
  dropCheck: { color: Colors.white, fontFamily: Fonts.bodyBold, marginLeft: 10 },
  tableHead: {
    flexDirection: 'row',
  ...
  headText: { fontSize: 14, fontFamily: Fonts.bodyBold, color: Colors.white },
  ...
  rowName: { fontSize: 16, fontFamily: Fonts.bodySemiBold, color: Colors.textPrimary, marginBottom: 4 },
  rowInfo: { fontSize: 12, fontFamily: Fonts.bodyRegular, color: Colors.textSecondary },
  cell: {
    minWidth: 56,
    paddingVertical: 8,
    alignItems: 'center',
  ...
  cellText: { fontSize: 16, fontFamily: Fonts.scoreBold, color: Colors.textPrimary },
  cellTextSoft: { color: Colors.textSecondary },
  disabledText: { color: Colors.textSecondary, fontFamily: Fonts.bodyBold },
